...
* Bonus class, Thursday, Dec. 15th &mdash; As we did on Saturday, Nov. 19th, we will see how Newton's results are obtained with calculus &mdash; On Nov. 19th, we used polar coordinates and differential equations to show that ellipses are a solution of Newton's laws &mdash; For this class, we will set up and do the triple integral that proves the Shell Theorem (the azimuthal and radial integrals are straightforward, which leaves us a potentially-tricky integration over the polar angle)
